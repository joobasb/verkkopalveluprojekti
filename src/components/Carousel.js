...
export default function Carousel() {
  return (
    ...
    <div class="row"> 
    <div class="col-lg-4">
    <img src="images/image1.jpg" alt="..." class="rounded-circle" width="200" height="200"/>      
    <p><a class="btn btn-secondary" href="#">Oluet &raquo;</a></p>
    </div>
    <div class="col-lg-4">
    <img src="images/image2.jpg" alt="..." class="rounded-circle" width="200" height="200"/>      
      <p><a class="btn btn-secondary" href="#">Oheistuotteet &raquo;</a></p>
    </div>
    <div class="col-lg-4">
    <img src="images/image3.jpg" alt="..." class="rounded-circle" width="200" height="200"/>      
