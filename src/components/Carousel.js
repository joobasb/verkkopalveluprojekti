  ...
  return (
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
      ...
      <div>
        ...
        <div class="row"> 
          <div class="col-lg-4">
          <img src="images/image1.jpg" alt="..." class="rounded-circle border border-light" width="300" height="300"/>      
          <p><a class="btn btn-secondary" href="#">Oluet &raquo;</a></p>
          </div>
          <div class="col-lg-4">
          <img src="images/image2.jpg" alt="..." class="rounded-circle border border-light" width="300" height="300"/>      
            <p><a class="btn btn-secondary" href="#">Oheistuotteet &raquo;</a></p>
          </div>
          <div class="col-lg-4">
          <img src="images/image3.jpg" alt="..." class="rounded-circle border border-light" width="300" height="300"/>      
